...
landmask <- readr::read_csv("C:/documents/philipiness/temp/stormwindmodel/data-raw/landseamask_ph1.csv",col_names = c("longitude", "latitude", "land")) %>%
...
##Next, the code estimates the radius for the end of the transition period, R2. We assume that smaller storms (Rmax ≤ 20 km) have a ##transition region of 15 km while larger storms (Rmax > 20 km) have a transition region of 25 km:
