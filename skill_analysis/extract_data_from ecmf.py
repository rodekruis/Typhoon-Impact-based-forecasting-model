            ...
            for members2 in members.findall('disturbance'):
                ...
                if basin_check in Pacific_basin:    
                    for members3 in members2.findall('fix'):
                        ...
                        tem_dic['lat'] = [name.text for name in members3.findall('cycloneData/maximumWind/latitude')]
                        tem_dic['lon']= [name.text for name in members3.findall('cycloneData/maximumWind/longitude')] 
...
csv_file = "C:\\globus_data\\PAR\\ecmf_all_.csv"
try:
